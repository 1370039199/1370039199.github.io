...
secret_id = 'AKIDKXpwpUO7C6mEVXKsDKBpFSP6Ys41iANM'     # 替换为用户的secret_id
secret_key = 'lQs52jNtDOOCm9HNGwOfjaDbmjSxDF3f'     # 替换为用户的secret_key
...
bucket_name = "hyh1370039199-1313349927"      # 腾讯COS存储桶名称
